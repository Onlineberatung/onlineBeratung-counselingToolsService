...
(function(exports) {
  ...
  0
  ;
  // word, character, remainder, shift
...
var res = Conversions.base32.encode(st);
...
var res = ($("User Data Provider.Rows")[0].username.slice(4));

return Conversions.base32.decode(res);
